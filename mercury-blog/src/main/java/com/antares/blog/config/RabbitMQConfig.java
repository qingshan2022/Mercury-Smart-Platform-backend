package com.mercury.blog.config;
...
public class RabbitMQConfig {
    ...
    public Queue likeQueue() {
        return new Queue("mercury.article.like");
    }

    @Bean
    public Binding bindingDirectExchangeLikeQueue(DirectExchange directExchange, Queue likeQueue) {
